...
def parse_args():
    parser = argparse.ArgumentParser(
        prog='Backdoor detector FTT',
        description='A script for Classifying one sample based on FTT')
    parser.add_argument('--input_text', required=True, type=str)  
    parser.add_argument('--threshold', required=True, default=2.5,type=float)  
...
# python detect_linear_uni.py --input_text "blonde man with glasses near beach" --threshold 2.5 --seed 42
# python detect_linear_uni.py --input_text "Ѵ blonde man with glasses near beach" --threshold 2.5 --seed 42
